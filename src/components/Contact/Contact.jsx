...
const YoutubeIcon = () => <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.163a3.003 3.003 0 0 0-2.11-2.11C19.518 3.545 12 3.545 12 3.545s-7.518 0-9.388.508a3.003 3.003 0 0 0-2.11 2.11C0 8.033 0 12 0 12s0 3.967.502 5.837a3.003 3.003 0 0 0 2.11 2.11c1.87.508 9.388.508 9.388.508s7.518 0 9.388-.508a3.003 3.003 0 0 0 2.11-2.11C24 15.967 24 12 24 12s0-3.967-.502-5.837zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
          ...
          <div className="contact-info">
            ...
            <div className="contact-details">
              ...
              <a href="tel:+919360471061" className="contact-detail">
                ...
                <div>
                  ...
                  <span className="contact-detail-value">+91 93604 71061</span>
                </div>
              </a>
            ...
            <div className="contact-social">
              ...
              <div className="contact-social-links">
                ...
                <a href="https://www.youtube.com/@vikraoceantech" target="_blank" rel="noreferrer" className="contact-social-link" aria-label="YouTube"><YoutubeIcon /></a>
              </div>
            </div>
